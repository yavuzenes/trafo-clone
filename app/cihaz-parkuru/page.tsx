...
export default function Page() {
  return <><Header/><main className="equipment-catalog-page"><div className="shell">
    ...
    <p className="equipment-note">Görseller ilgili ürünleri tanıtmak içindir. Sahada kullanılacak model, cihaz envanteri ve kalibrasyon durumu hizmet öncesinde teyit edilir.</p>
  </div></main><Footer/></>;
}
